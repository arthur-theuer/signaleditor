...
<div class="meta-section mb-page" onkeydown={handleKeydown}>
  ...
  <div class="flex flex-col sm:flex-row sm:flex-wrap gap-card p-card">
    {#if isStrecke && streckeMeta}
      <div class="meta-field flex flex-col grow min-w-0 sm:order-0 sm:grow-0 sm:basis-[calc(50%-var(--spacing-card)/2)] lg:grow lg:basis-auto">
    ...
    {/if}
    <div class="meta-field flex flex-col grow min-w-0 sm:order-1 lg:order-none">
