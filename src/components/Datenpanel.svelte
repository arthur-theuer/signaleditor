...
<div class="daten-section mb-page" onkeydown={handleKeydown}>
  ...
  <div class="flex flex-col sm:flex-row sm:flex-wrap gap-card p-card">
    <div class={primaryClass}>
      ...
      <span class="hl-wrap">
        <input id={primaryId} type="text" value={primaryValue} oninput={handlePrimaryInput} placeholder={primaryPlaceholder} />
      </span>
    </div>
    ...
    <div class={secondaryClass}>
      ...
      <span class="hl-wrap">
        <input id="meta-via" type="text" bind:value={data.meta.via} oninput={(e) => autoArrow(e, v => data.meta.via = v)} placeholder="z.B. VL, NBS" />
      </span>
    </div>
    <div class={primaryClass}>
      <label for="meta-name">Name</label>
      <span class="hl-wrap">
        <input id="meta-name" type="text" bind:value={data.meta.name} oninput={(e) => autoArrow(e, v => data.meta.name = v)} placeholder="z.B. Olten → Aarau" />
      </span>
    </div>
  </div>
</div>
